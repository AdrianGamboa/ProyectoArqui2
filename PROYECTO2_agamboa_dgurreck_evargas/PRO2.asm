...
;-------------
    ...
    PATHNMl DB 'Partidas/prueba.txt' , 00H
    HANDLE1 DW ? 
...
DETERMINA_GANADOR PROC
    ...
    TERMINA_DETERMINA_GANADOR:
        POS_CURSOR 14,25
        MOV AH, 09H
        LEA DX, MSG_PUNTOS_JUG1
        INT 21H

        POS_CURSOR 14,43
        CALL DETERMINA_PTS_JUG1
        
        POS_CURSOR 16,25
        MOV AH, 09H
        LEA DX, MSG_PUNTOS_JUG2
        INT 21H

        POS_CURSOR 16,43
        CALL DETERMINA_PTS_JUG2
...
DETERMINA_PTS_JUG1 PROC
    LEA SI, PUNTOS_JUGADOR1
    MOV BL, [SI]
    
    CMP GANADOR, 1
    JE PUNTOS_OBTENIDOS_JUG1
    JMP SUM_5_JUG1
    
    PUNTOS_OBTENIDOS_JUG1:
        CMP TURNO_JUGADOR, 0
        JE IMPRIME_PJUG1
        CMP TURNO_JUGADOR, 1
        JE SUM_10_JUG1
    ...
    INT 21H
    RET
DETERMINA_PTS_JUG1 ENDP

DETERMINA_PTS_JUG2 PROC
    LEA SI, PUNTOS_JUGADOR2
    MOV BL, [SI]

    CMP GANADOR, 1
    JE PUNTOS_OBTENIDOS_JUG2
    JMP SUM_5_JUG2
    
    PUNTOS_OBTENIDOS_JUG2:
        CMP TURNO_JUGADOR, 0
        JE SUM_10_JUG2
        CMP TURNO_JUGADOR, 1
        JE IMPRIME_PJUG2
